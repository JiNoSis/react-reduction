           ...
           <thead>
            ...
            <tbody>
                ...
                <tr class="schedule">
                  ...
                  <td class="schedule">{Wed1}<br></br>{W1_room}</td>
                  <td class="schedule">{Wed1}<br></br>{W1_room}</td>
                  <td class="schedule">{Wed1}<br></br>{W1_room}</td>
                  <td className="lunch"> Lunch</td>
                  <td class="schedule">{Wed2}<br></br>{W2_room}</td>
                  <td class="schedule">{Wed2}<br></br>{W2_room}</td>
                  <td class="schedule">{Wed2}<br></br>{W2_room}</td>
                </tr>
                <tr class="schedule">
                  <th align="center">Thursday</th>   
                  <td class="schedule">{Thu1}<br></br>{Th1_room}</td>
                  <td class="schedule">{Thu1}<br></br>{Th1_room}</td>
                  <td class="schedule">{Thu1}<br></br>{Th1_room}</td>
                  <td className="lunch"> Lunch</td>
                  <td class="schedule">{Thu2}<br></br>{Th2_room}</td>
                  <td class="schedule">{Thu2}<br></br>{Th2_room}</td>
                  <td class="schedule">{Thu2}<br></br>{Th2_room}</td>
                </tr>
                ...
                <tr class="schedule">
                  ...
                  <td class="schedule">{Fri1}<br></br>{F1_room}</td>
                  <td class="schedule">{Fri1}<br></br>{F1_room}</td>
                  <td class="schedule">{Fri1}<br></br>{F1_room}</td>
                  <td className="lunch"> Lunch</td>
                  <td class="schedule">{Fri2}<br></br>{F2_room}</td>
                  <td class="schedule">{Fri2}<br></br>{F2_room}</td>
                  <td class="schedule">{Fri2}<br></br>{F2_room}</td>
                </tr>
